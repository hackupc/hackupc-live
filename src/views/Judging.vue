<template>
  <div id="judging" class="under-header padding-bottom">
    <div class="container">
      ...
      <div class="panel large">
        <div style="text-align: justify">
          ...
          <p class="margin-bottom">How technically impressive was the hack?</p>
          <br />
      ...
      <div class="panel large">
        <div style="text-align: justify">
          ...
          <p class="margin-bottom">
            Is the idea solving the challenge proposed?
          </p>
          <br />
          <p class="margin-bottom">
            Would it be possible to use this project to help the challenge
            proposed?
          </p>
        </div>
      </div>
