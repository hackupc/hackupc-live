    ...
    <div class="container">
      <div class="panel large">
        ...
        <div>
          ...
          <div class="prizes-container">
            <div><h3>1st</h3><p>Bose Quietcomfort 35 II</p></div>
            <div><h3>2nd</h3><p>3D printer Anet A6</p></div>
            <div><h3>3rd</h3><p>Echo Show 5</p></div>
          </div>
        </div>
      </div>
      <div class="panel">
      ...
      <div class="panel">
        ...
        <div>
          ...
          <p class="margin-bottom">Are you ready to hack for good? Take the datasets and build a great technological solution that makes cities inclusive, safe, resilient and sustainable. Make something innovative that brings positive change to the world, even something that solves a small problem. It's that simple #everisHack4good</p>
          <div>
      ...
      <div class="panel">
        ...
        <div>
          ...
          <p class="margin-bottom">We encourage you to design and build an app that includes your preferred feature and help our university to become digital!</p>
          <div>
            <p><b>Prizes:</b></p>
            <ul class="no-indent">
      ...
      <div class="panel">
        ...
        <div>
          ...
          <p class="margin-bottom">RAISE AWARENESS Spread the word about the climate crisis. Help people understand the urgency of this matter."</p>
          <div>
      ...
      <div class="panel">
        ...
        <div>
          ...
          <p class="margin-bottom">For more details, please check our <a href="https://docs.restb.ai">docs page</a> or come visit us at our booth; we promise we are really friendly and would love to chat with you about anything that comes to your mind!</p>
          <div>
