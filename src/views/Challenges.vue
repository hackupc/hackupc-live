<template>
  <div id="schedule" class="under-header padding-bottom">
    <div class="container">
      <div class="panel">
        <h1>
          Looking for similar patients: the AI Doctor House conquers severe
          COVID-19!
        </h1>
        ...
        <div>
          <h3>
            <a
              href="https://doi.org/10.5281/zenodo.4314709"
              target="_blank"
              class="external-link"
              >Input data</a
            >
          ...
          <h3>
            <a
              href="https://youtube.com/playlist?list=PL5uSCzf1azhBeVCHyswazImBNpIW8gYTD"
              target="_blank"
              class="external-link"
              >YouTube Channel with more information</a
            >
          </h3>
          <div class="embed-container">
            <iframe
              src="https://www.youtube.com/embed/XmMq8xEMuLQ"
              class="embed"
              frameborder="0"
      ...
      <div class="panel">
        ...
        <div>
          <h3>
            <a
              href="data/COPEDICATClinicSympt_DATA_2020-12-17_1642.csv"
              target="_blank"
              class="external-link"
              >Input data</a
            >
          ...
          <h3>
            <a
              href="data/COPEDI-CAT_clinic_symptoms_REDCap.pdf"
              target="_blank"
              class="external-link"
              >Data dictionary</a
            >
          ...
          <div class="embed-container">
            <iframe
              src="https://www.youtube.com/embed/rY_rAyjO6Nw"
              class="embed"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
      ...
      <div class="panel">
        <h1>
          Do you have COVID-19 cough? Help distinguishing which type of cough
          you have
        </h1>
        <div class="text-centered">
          <p class="icon"><i class="fab fa-discord" aria-hidden="true"></i></p>
        ...
        <div>
          <h3>
            <a
              href="https://b2sdata.upc.edu:5001/d/f/590044504787040823"
              target="_blank"
              class="external-link"
              >Input data</a
            >
          ...
          <h3>
            <a
              href="https://github.com/b2slab/covidscipy2020/tree/mainbranch/HACKATHON%202020"
              target="_blank"
              class="external-link"
              >Useful codes</a
            >
          ...
          <div class="embed-container">
            <iframe
              src="https://www.youtube.com/embed/InlBAJF8Gso"
              class="embed"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
      ...
      <div class="panel">
        <h1>
          COVIDTracking-Primary Health Care Centres: Help the front line of
          medical care!
        </h1>
        <div class="text-centered">
          <p class="icon"><i class="fab fa-discord" aria-hidden="true"></i></p>
        ...
        <div>
          ...
          <div class="embed-container">
            <iframe
              src="https://www.youtube.com/embed/sj_Lyo-ayQU"
              class="embed"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
      ...
      <div class="panel">
        ...
        <div>
          ...
          <div class="embed-container">
            <iframe
              src="https://www.youtube.com/embed/FQzpNFU6TNs"
              class="embed"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
      ...
      <div class="panel">
        ...
        <div>
          ...
          <div class="embed-container">
            <iframe
              src="https://www.youtube.com/embed/g9RpYlUZ_AU"
              class="embed"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
