...
If you want to keep track of the number of points earned, you can use [this spreadsheet](https://docs.google.com/spreadsheets/d/16M5zLWoqDwzYZNwg1gOq-D0h3x5SEdXao2RQlP5UMc0/). You should create a copy of it, and then you can check which activities you took part and the tiers where prizes are given.

Once you reach a tier, you can go to the infodesk (same location than baggage) and claim your reward! Don't forget to bring your card to show your attendance. If there isn't an organizer to stamp your card, you should go to the infodesk and show a proof that you have completed the task.`,
    size: 'small',
  },
  {
    title: 'Online',
